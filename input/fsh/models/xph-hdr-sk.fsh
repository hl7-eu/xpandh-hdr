...
* header.subject-identification.language 0..0 CodeableConcept "A.1.1.7-Language communication [Optional]" """Patient communication language. Multiple communication languages might be provided.  """				
...
* header.subject-contact.contactPoint.person.role 0..0 CodeableConcept "A.1.2.3.1-Role of that person [Required]" """Role of the contact person: legal guardian, next of kin, other person to contact."""				
* header.subject-contact.contactPoint.person.relationship 0..0 CodeableConcept "A.1.2.3.2-Relationship level [Required]" """Relationship type with the patient (e.g. father, wife, daughter)"""				
* header.subject-contact.contactPoint.person.identifier 0..0 Identifier "A.1.2.3.3-Identifier [Optional]" """An identifier of the healthcare professional that is unique within a defined scope. Example: National personal ID, passport number etc. Multiple identifiers could be provided.  """				
...
* header.subject-contact.contactPoint.person.address 0..0 Address "A.1.2.3.6-Address [Optional]" """Mailing, home or office addresses. The addresses are always sequences of address parts (e.g. street address line, country, ZIP code, city) even if postal address formats may vary depending on the country. An address may or may not include a specific use code; if this attribute is not present it is assumed to be the default address useful for any purpose."""				
* header.subject-contact.contactPoint.person.telecom 0..0 ContactPoint "A.1.2.3.7-Telecom [Required]" """Telecommunication contact information (addresses) associated to a person. Multiple telecommunication addresses might be provided."""				
