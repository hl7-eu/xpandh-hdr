...
* discharge.destinationType 0..1 CodeableConcept "A.2.3.5.2 - Discharge destination type [Required]" """Type of location to which the patient will go after the encounter. E.g. home, hospital, nursing home, left against medical advice etc.ÿÿ"""				
...
* location.organization.identifier 0..1 Identifier "A.2.3.6.2 - Organization Id [Required]" """The organization?s part identifier."""				
