...
Id: Composition-eu-xpandh
Title: "Clinical Document"
Description: "Generic Clinical Document profile for the XPanDH project."
* ^status = #active
* . ^short = "International Patient Summary composition"
* . ^definition = "This profiles specifies common rules for clincal document to be used for the XPanDH project. \r\nA composition is a set of healthcare-related information that is assembled together into a single logical document that provides a single coherent statement of meaning, establishes its own context and that has clinical attestation with regard to who is making the statement. \r\nWhile a Composition defines the structure, it does not actually contain the content: rather the full content of a document is contained in a Bundle, of which the Composition is the first resource contained."
* text MS
* identifier MS
* status MS
